...
# [... INIT_SEQUENCE, GAIN_VALUES, GAIN_REGISTERS identiques au fichier original ...]
# Je copie les données depuis le document 9
...
INIT_SEQUENCE = [
    ...
    # [... reste de la séquence d'init identique ...]
    # Analog control
    (0x3600, 0x84, 0),
    (0x3603, 0x08, 0),
    (0x3610, 0x57, 0),
    ...
    # [Suite de l'init - identique au fichier original]
    # Sensor core control
    (0x3708, 0x30, 0),
    (0x3714, 0x24, 0),
    (0x3725, 0x02, 0),
...
# Mapping des registres de gain (identique)
GAIN_REGISTERS = [
    # 1x analog, digital fine variation
